...
function(setup_gamecube_executable target_name libogc_libs)

    target_link_libogc("${target_name}" "${libogc_libs}" "cube")
    setup_gamecube_link_compile_flags("${target_name}")

endfunction(setup_gamecube_executable)

# Set up a Wii executable target
# Add the definition for the libogc headers
function(setup_wii_executable target_name libogc_libs)

    target_link_libogc("${target_name}" "${libogc_libs}" "wii")
    setup_wii_link_compile_flags("${target_name}")

endfunction(setup_wii_executable)

function(setup_gamecube_link_compile_flags target_name)
...
endfunction(setup_gamecube_link_compile_flags)

function(setup_wii_link_compile_flags target_name)
...
function(target_link_libogc target_name libogc_libs path_suffix)
    ...
    foreach(libogc_lib ${libogc_libs})
        ...
        target_link_libraries(${target_name} PUBLIC "LIBOGC_${libogc_lib}")
